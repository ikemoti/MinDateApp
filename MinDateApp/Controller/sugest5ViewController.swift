...
class sugest5ViewController: UIViewController,UISearchBarDelegate ,UITableViewDataSource,UITableViewDelegate,MKLocalSearchCompleterDelegate {
    ...
    var searchCompleter = MKLocalSearchCompleter()
        ...
        override func viewDidLoad() {
            super.viewDidLoad()
            sugestTbleView.delegate = self
            sugestTbleView.dataSource = self
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = sugestTbleView.dequeueReusableCell(withIdentifier: "sugestcell5" ,for: indexPath)
    ...
    //
            ...
            preVC.Place5?.text = completion.title
